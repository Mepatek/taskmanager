...
/*  Created On : 12-úno-2016 20:14:04 				*/
/*  DBMS       : SQL Server 2012 						*/
/* ---------------------------------------------------- */

/* Drop Foreign Key Constraints */

IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[FK_TaskHistory_Tasks]') AND OBJECTPROPERTY(id, 'IsForeignKey') = 1) 
...
IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = object_id('[TaskHistory]') AND OBJECTPROPERTY(id, 'IsUserTable') = 1) 
...
ALTER TABLE [TaskHistory] 
 ADD CONSTRAINT [PK_TaskHistory]
	PRIMARY KEY CLUSTERED ([TaskHistoryID])
GO
